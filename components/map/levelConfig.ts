...
export const GAME_LEVELS: LevelConfig[] = [
  ...
  { 
    // Level 2
    difficultyMult: 1.0, 
    unitCounts: { [UnitType.INFANTRY]: 3, [UnitType.ARCHER]: 3 }, 
    enemyCommanders: [] 
  },
  { 
    // Level 3: Unlock Shield (Warlord)
    difficultyMult: 1.0, 
    unitCounts: { [UnitType.INFANTRY]: 5, [UnitType.ARCHER]: 4, [UnitType.SHIELD]: 2 }, 
    enemyCommanders: [] 
  },
  { 
    // Level 4: MINI BOSS
    difficultyMult: 1.05, 
    unitCounts: { [UnitType.INFANTRY]: 7, [UnitType.ARCHER]: 6, [UnitType.SHIELD]: 3, [UnitType.SPEAR]: 2 }, 
  ...
  { 
    ...
    difficultyMult: 1.15, 
    unitCounts: { [UnitType.INFANTRY]: 10, [UnitType.ARCHER]: 9, [UnitType.SHIELD]: 7, [UnitType.SPEAR]: 6 }, 
    enemyCommanders: [UnitType.COMMANDER_GUARDIAN] 
  },
  { 
    // Level 7: FINAL BOSS (Vanguard + Warlord)
    difficultyMult: 1.25, 
    unitCounts: { [UnitType.INFANTRY]: 13, [UnitType.ARCHER]: 13, [UnitType.SHIELD]: 13, [UnitType.SPEAR]: 10 }, 
